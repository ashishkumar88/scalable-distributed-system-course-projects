package edu.northeastern.cs6650.project4.client;
/**
...
import edu.northeastern.cs6650.project4.client.KeyValueStoreRMIClient;
...
public class Client 
{
    ...
    public static void main(String[] arguments)
    {
        if(arguments.length < 2) {
            LOGGER.severe("Incorrect number of arguments. Correct usage: java -classpath classes edu.northeastern.cs6650.project4.client.Client <server ip address> <server port number> false(optional) false(optional).");
        } else {
            try {
