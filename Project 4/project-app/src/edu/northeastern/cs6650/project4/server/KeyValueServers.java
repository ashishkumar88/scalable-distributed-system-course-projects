...
import edu.northeastern.cs6650.project4.server.KeyValueStoreRMIServer;
...
public class KeyValueServers {
    ...
    public static void main(String[] arguments) {  
        ...
        if(arguments.length != 3) {
            System.err.println("Incorrect number of arguments. Correct usage: java -classpath classes edu.northeastern.cs6650.project4.server.Server <server ip> <server port> <number key value servers>.");
        } else {
            try {
