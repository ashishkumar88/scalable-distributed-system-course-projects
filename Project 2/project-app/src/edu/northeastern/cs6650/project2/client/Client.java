...
import edu.northeastern.cs6650.project2.client.KeyValueStoreRMIClient;
 ...
 * 2. <server port> - Port on which the server registry is listening on.
 * 
...
public class Client 
{
    ...
    public static void main(String[] arguments)
    {
        if(arguments.length < 2) {
            LOGGER.severe("Incorrect number of arguments. Correct usage: java -classpath classes edu.northeastern.cs6650.project2.client.Client <server ip address> <server port number> false(optional) false(optional).");
        } else {
            try {
                ...
                if(isPrepopulateRequired) {
                    ...
                    Runnable putTask = () -> { 
                        try {
                            ...
                            LOGGER.severe("Server PUT request failed.");
                        }
                    };
                        ...
                        switch(requestType) {
                            ...
                            case PUT: // Perform the PUT operation
                                ...
                                if(!(Utils.isKeyValid(key) && Utils.isValueValid(value))) {
                                    ...
                                    client.makePutRequest(key, value);
